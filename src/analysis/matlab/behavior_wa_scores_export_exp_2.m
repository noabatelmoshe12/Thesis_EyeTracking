...
subjects = setdiff(201:228, [208 221]); % Noa: Exp. 2 subjects, excluding 208 and 221 according to current eye-tracking QC decisions
...
output_file = fullfile(output_dir, 'behavior_wa_scores_exp2_excluding_208_221.csv');
